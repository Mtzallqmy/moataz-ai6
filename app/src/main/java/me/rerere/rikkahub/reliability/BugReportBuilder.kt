 ...
 *   - logcat.txt — last 60 minutes of logcat, filtered/redacted for Moataz AI diagnostics
...
class BugReportBuilder(private val context: Context) {
    ...
    suspend fun build(): File = withContext(Dispatchers.IO) {
        ...
        val zipFile = File(outDir, "moataz-ai-bug-$ts.zip")

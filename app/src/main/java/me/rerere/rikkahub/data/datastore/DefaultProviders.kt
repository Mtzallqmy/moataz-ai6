...
import me.rerere.ai.provider.OpenAICompatibilityCapabilities
...
val DEFAULT_PROVIDERS = listOf(
    ...
    ProviderSetting.OpenAI(
        ...
        compatibilityPreset = OpenAICompatiblePreset.OPENAI,
        apiKey = "",
        enabled = false,
        builtIn = true
    ),
    ProviderSetting.OpenAI(
        id = Uuid.parse("4d1c52d8-5d40-4d61-8ea4-1eb46c754001"),
        name = "NVIDIA NIM",
        baseUrl = NVIDIA_NIM_DEFAULT_BASE_URL,
        apiKey = "",
        enabled = false,
        builtIn = true,
        compatibilityPreset = OpenAICompatiblePreset.NVIDIA,
    ...
    ProviderSetting.OpenAI(
        id = Uuid.parse("4d1c52d8-5d40-4d61-8ea4-1eb46c754002"),
        name = "Hugging Face",
        ...
        enabled = false,
        builtIn = true,
        compatibilityPreset = OpenAICompatiblePreset.HUGGING_FACE,
        compatibilityCapabilities = OpenAICompatibilityCapabilities(
            responsesApi = false,
            embeddings = false,
            imageGeneration = false,
    ...
    ProviderSetting.OpenAI(
        id = Uuid.parse("4d1c52d8-5d40-4d61-8ea4-1eb46c754003"),
        ...
        shortDescription = {
            Text(stringResource(R.string.openai_compatible_provider_short_description))
        },
    ),

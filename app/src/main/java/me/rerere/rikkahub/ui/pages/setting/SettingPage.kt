...
fun SettingPage(vm: SettingVM = koinViewModel()) {
    ...
    if (settings.launchCount > 100 && (settings.launchCount - settings.sponsorAlertDismissedAt) >= 50) {
        AlertDialog(
            ...
            text = { Text(stringResource(R.string.support_project_github_desc)) },
            confirmButton = {
                Button(onClick = {
                    vm.updateSettings(settings.copy(sponsorAlertDismissedAt = settings.launchCount))
                    navController.navigate(Screen.SettingDonate)
                }) {
                    Text(stringResource(R.string.support_project_open))
                }
            },
            dismissButton = {
                TextButton(onClick = {
        ...
        LazyColumn(
            ...
            item("aboutSettings") {
                ...
                CardGroup(
                    ...
                    item(
                        onClick = {
                            context.openUrl("https://github.com/Mtzallqmy/moataz-ai6#readme")
                        },
                    ...
                    item(
                        ...
                        headlineContent = { Text(stringResource(R.string.support_project_title)) },
                    )
                    item(
                        onClick = {

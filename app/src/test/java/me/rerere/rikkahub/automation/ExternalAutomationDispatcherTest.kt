...
class ExternalAutomationDispatcherTest {
    ...
    @Test fun `action constants match spec strings exactly`() {
        ...
        assertEquals("ai.moataz.RUN_TASK", ExternalAutomationDispatcher.ACTION_RUN_TASK)
        assertEquals("ai.moataz.RUN_CHAT", ExternalAutomationDispatcher.ACTION_RUN_CHAT)
    }
